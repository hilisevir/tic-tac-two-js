...
function cellUpdateFnABC(x, y, e) {
    game.makeAMove(x, y);
...
let boardController = UI.getGamePageUI(game)
let board = UI.getInitialBoard(game, cellUpdateFnABC);
...
export function updateGridUI() {
    ...
    cells.forEach((cell, index) => {
        ...
        pieces[index].textContent = game.board[x][y] || null;
    });
...
export function updateNextMoveIndicator() {
